...
final _zh2Grammar = GrammarLesson(
  ...
  longForm: LongFormContent(
    narrative: [
      'Un francophone qui commande "un café" n\'a jamais eu à réfléchir à '
          'la forme de ce qu\'il compte : le nombre se colle directement au '
          'nom. Le chinois interdit ce raccourci. Entre le nombre et le nom, '
          'un mot obligatoire — le classificateur — dit à quelle catégorie '
          'appartient l\'objet compté : un contenant (杯 pour un verre), une '
          'unité générique (个), une portion (份), une surface plate (张). '
          'Oublier le classificateur en chinois, ce n\'est pas une maladresse '
          'stylistique, c\'est une phrase agrammaticale — un peu comme dire '
          '"deux pain" sans article en français.',
      'La comparaison la plus utile n\'est pas avec le français mais avec '
          'les rares survivances françaises du même principe : on dit "une '
          'feuille de papier", "un morceau de pain", "un verre d\'eau" — le '
          'français a bien des classificateurs, mais seulement pour les '
          'matières indénombrables. Le chinois généralise ce principe à '
          'PRESQUE TOUS les noms, y compris les personnes (个 rén, "un '
          'individu-personne") et les objets comptables un par un.',
      'Le réflexe à corriger n\'est donc pas d\'apprendre une exception, '
          'mais d\'accepter que chaque nom chinois porte, implicitement, une '
          'catégorie de forme ou de fonction que le locuteur doit connaître '
          'avant de le compter. 个 (gè) est le classificateur passe-partout '
          'qui dépanne dans le doute, mais un chinois natif remarquera '
          'immédiatement "一个咖啡" au lieu de "一杯咖啡" — comme un français '
          'tiquerait sur "un morceau d\'eau" au lieu de "un verre d\'eau".',
      'Une dernière nuance mérite d\'être posée tôt : 几 (jǐ) et 多少 '
          '(duōshao) traduisent tous deux "combien", mais 几 attend une '
          'réponse petite et précise (moins d\'une dizaine) et garde son '
          'classificateur ("几个人" — combien de personnes), tandis que 多少 '
          's\'utilise pour un nombre indéterminé ou potentiellement grand et '
          'se passe généralement de classificateur.',
    ],
    dialogue: [
      _zhLine(
        '[你好|bonjour|nǐ hǎo]，[请问|s\'il vous plaît|qǐngwèn]，[有没有|y en a-t-il|yǒu méiyǒu][素的|vegetarien|sù de]？',
        speaker: 'Client',
        native: 'Bonjour, excusez-moi, avez-vous quelque chose de '
            'végétarien ?',
        note: '有没有 (V+没+V) remplace 吗 pour poser la question : aucun '
            'classificateur nécessaire ici, il n\'y a pas encore de nombre.',
      ),
      _zhLine(
        '[有|il y en a|yǒu][一份|une portion|yí fèn][米饭|de riz|mǐfàn]。',
        speaker: 'Serveuse',
        native: 'Il y a un plat de riz.',
        note: '份 (fèn) compte une portion, un plat commandé — pas 个.',
      ),
      _zhLine(
        '[好|bien|hǎo]，[还要|et aussi|hái yào][一杯|un verre|yì bēi][茶|de thé|chá]。',
        speaker: 'Client',
        native: 'Bien, et aussi un thé.',
        note: '杯 (bēi) est réservé aux boissons servies dans un contenant : '
            'jamais 个 pour une boisson.',
      ),
      _zhLine(
        '[几个|combien de|jǐ ge][人|personnes|rén]？',
        speaker: 'Serveuse',
        native: 'Combien de personnes ?',
        note: '几 attend un petit nombre et garde son classificateur (个 '
            'pour "personne") juste après.',
      ),
      _zhLine(
        '[两个|deux|liǎng ge][人|personnes|rén]，[谢谢|merci|xièxie]。',
        speaker: 'Client',
        native: 'Deux personnes, merci.',
        note: '两 (liǎng) remplace 二 (èr) devant un classificateur : on ne '
            'dit jamais 二个人.',
      ),
      _zhLine(
        '[没问题|pas de problème|méi wèntí]，[这张|cette|zhè zhāng][桌子|table|zhuōzi][可以|convient|kěyǐ]。',
        speaker: 'Serveuse',
        native: 'Pas de problème, cette table convient.',
        note: '张 (zhāng) classe les surfaces plates : une table, comme un '
            'billet ou une feuille de papier.',
      ),
    ],
    walkthroughs: [
      WorkedExample(
        ...
        parts: [
          WorkedExamplePart(
            chunk: '我要',
            explanation: '"je veux/voudrais" — le sujet et le verbe, sans '
                'marqueur de politesse séparé comme en anglais.',
          ),
          WorkedExamplePart(
            chunk: '一杯',
            explanation:
                '一 (un) + 杯 (bēi, classificateur des boissons servies '
                'dans un contenant) : jamais "一咖啡" seul.',
          ),
          WorkedExamplePart(
            chunk: '咖啡',
            explanation: 'le nom compté, placé après le classificateur, pas '
                'avant.',
          ),
          WorkedExamplePart(
            chunk: '和',
            explanation: '"et", reliant deux groupes nombre-classificateur-'
                'nom complets.',
          ),
          WorkedExamplePart(
            chunk: '一份米饭',
            explanation:
                'même structure répétée avec 份 (fèn, une portion) : chaque '
                'nom compté a besoin de son propre classificateur, on ne '
                'peut pas le sous-entendre pour le second élément.',
          ),
        ],
      ),
      WorkedExample(
        ...
        parts: [
          WorkedExamplePart(
            chunk: '这个房间里',
            explanation:
                '这 (ce) + 个 (classificateur passe-partout) + 房间 (pièce) '
                '+ 里 (à l\'intérieur de) : même "ce" a besoin d\'un '
                'classificateur devant un nom compté.',
          ),
          WorkedExamplePart(
            chunk: '有',
            explanation: '"il y a" — verbe d\'existence, sans lien avec '
                '"être".',
          ),
          WorkedExamplePart(
            chunk: '几个',
            explanation:
                '几 (combien, petit nombre attendu) suivi de son '
                'classificateur 个, jamais l\'inverse.',
          ),
          WorkedExamplePart(
            chunk: '人？',
            explanation: 'le nom compté ferme la phrase ; le ？final marque '
                'la question, sans inversion ni 吗 supplémentaire.',
          ),
        ],
      ),
    ],
